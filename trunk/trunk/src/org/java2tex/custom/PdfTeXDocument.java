...
/**
 * The basic representation of a document appropriate for the PdfTeX processor.
 ...
 * @version <tt>1.0</tt>
 */
public class PdfTeXDocument extends LatexDocument {
	
	private static final Logger log = Logger.getLogger( PdfTeXDocument.class );
	...
	public void addPackage(String packageToAdd) {
